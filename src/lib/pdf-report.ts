...
export function generatePDF(r: ReportInput): jsPDF {
  ...
  doc.setFontSize(10); doc.text("EES / IVS 2025 Compliant - Port Said, Egypt", W/2, 20, { align: "center" });
  doc.setTextColor(0);
  ...
  for (let p=1; p<=pages; p++) {
    ...
    doc.text(`Page ${p} of ${pages} | EES / IVS 2025 | Generated by Port Said Appraiser`, W/2, 290, { align: "center" });
  }
