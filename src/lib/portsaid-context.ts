...
export const PORT_SAID_DISTRICTS: Record<string, DistrictProfile> = {
  "الشرق":   { name: "حي الشرق",   founded: "1880", dominantUse: "تجاري/سياحي", premiumPct: 12, notes: "أقدم الأحياء — النواة التاريخية (الحي الإفرنجي/اللاتيني)، قيمة العقار مدفوعة بالاستخدام التجاري والسياحي." },
  ...
  "الضواحي": { name: "حي الضواحي", founded: "حديث", dominantUse: "سكني + صناعي", premiumPct: -3, notes: "يضم المثلث والسرو والزراعات — خصم نوعية الجوار للملاصق للمنطقة الصناعية." },
  ...
  "الجنوب":  { name: "حي الجنوب",  founded: "2002", dominantUse: "ناشئ",         premiumPct: -2, notes: "أقصى جنوب المدينة على بحيرة المنزلة — سوق ناشئ يشمل الإسكان الاجتماعي و6 أكتوبر." },
  "الغرب":   { name: "حي الغرب",   founded: "2015", dominantUse: "ناشئ",         premiumPct: 2,  notes: "أحدث الأحياء السبعة — فُصل رسمياً عن حي الزهور — قاعدة بيانات قيد التكوين." },
  "بورفؤاد": { name: "حي بورفؤاد", founded: "2010", dominantUse: "سكني",          premiumPct: 5,  notes: "مدينة مستقلة منذ 2010 — الشطر الآسيوي عبر القناة — تشمل الكاب وفيلات الضباط وبورفؤاد الجديدة." },
};
