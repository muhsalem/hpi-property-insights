    ...
    <div className="space-y-4" dir="rtl">
      <div>
        <h1 className="text-2xl font-bold flex items-center gap-2">
          ...
          المؤشرات العقارية — منصة التقييم المتكاملة
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          7 محاور · 150+ مؤشر · منهجية RICS Red Book + IVS + UN-Habitat + CAPMAS
        </p>
      </div>

      {/*
        ════════════════════════════════════════════════════════════════════
        ترتيب احترافي وفق التسلسل المنطقي للتقييم العقاري الدولي:
        1) السكان        → فهم الطلب الأساسي (مَن المستفيد؟)
        2) السوق         → ديناميكيات العرض/الطلب الفعلية (ما حالة السوق؟)
        3) النماذج       → قياس الأسعار والاتجاهات إحصائياً (كم السعر؟)
        4) القدرة/تمويل  → ربط السعر بالدخل (هل ميسور؟)
        5) جودة الموقع   → خصائص العقار والمحيط (لماذا هذا السعر؟)
        6) المخاطر/قانوني→ تعديلات معدل الخصم (ما الخصم العادل؟)
      ...
      */}
      <Tabs defaultValue="flow">
        <TabsList className="grid grid-cols-2 md:grid-cols-8 w-full">
          ...
          <TabsTrigger value="affordability">🏠 القدرة والتمويل</TabsTrigger>
          <TabsTrigger value="urban">🏘️ جودة الموقع</TabsTrigger>
        ...
        <TabsContent value="population" className="space-y-4 mt-4">
          <Tabs defaultValue="kpis">
            <TabsList className="grid grid-cols-3 w-full">
              <TabsTrigger value="kpis">📊 ديموغرافيا متقدمة (55+)</TabsTrigger>
              <TabsTrigger value="capmas">🇪🇬 تصنيف CAPMAS</TabsTrigger>
              <TabsTrigger value="migration">🚚 الهجرة والتوزيع</TabsTrigger>
            </TabsList>
            <TabsContent value="kpis" className="mt-4"><Suspense fallback={<PanelFallback />}><DemographicsKpisPanel /></Suspense></TabsContent>
        ...
        <TabsContent value="market" className="space-y-4 mt-4">
          <Tabs defaultValue="advanced">
            <TabsList className="grid grid-cols-2 md:grid-cols-5 w-full">
              <TabsTrigger value="advanced">📊 KPIs متقدمة (45+)</TabsTrigger>
              <TabsTrigger value="comprehensive">📈 السوق الشاملة</TabsTrigger>
              <TabsTrigger value="supply">📦 العرض والامتصاص</TabsTrigger>
              <TabsTrigger value="demand">🛒 توقعات الطلب</TabsTrigger>
              <TabsTrigger value="map">🗺️ خريطة GIS</TabsTrigger>
            </TabsList>
            <TabsContent value="advanced" className="mt-4"><Suspense fallback={<PanelFallback />}><AdvancedMarketKpisPanel /></Suspense></TabsContent>
        ...
        <TabsContent value="models" className="space-y-4 mt-4">
          <Tabs defaultValue="hpi">
            ...
            <TabsContent value="caseshiller" className="space-y-4 mt-4">
              ...
              <Card>
                <CardHeader><CardTitle className="text-base">Case-Shiller — اسمي مقابل حقيقي (مُعدَّل بـ CPI المصري)</CardTitle></CardHeader>
                <CardContent>
                  ...
                  <div className="mt-4 grid md:grid-cols-2 gap-3 text-xs">
                    <div className="p-3 bg-muted rounded space-y-1">
                      ...
                      <div>• <b>تهذيب الصدمات:</b> سقف ±60% على العائد اللوغاريتمي السنوي لعزل تأثير تعويم الجنيه.</div>
                      <div>• <b>المؤشر الحقيقي:</b> قسمة المؤشر الاسمي على الرقم القياسي للأسعار (CAPMAS).</div>
                      <div>• <b>وزن بورسعيد:</b> أزواج البيع &lt; سنتين تُخفَّض أوزانها 50%.</div>
                      <div>• <b>عينة رقيقة:</b> سنوات بأقل من 3 أزواج تستعمل متوسط آخر 3 سنوات.</div>
                    </div>
                    <div className="p-3 bg-muted rounded space-y-1">
                      <div className="font-semibold">قراءة النتيجة:</div>
                      <div>• <b>الحقيقي &gt; 100</b>: نمو فعلي فوق التضخم (تحوّط ناجح).</div>
                      <div>• <b>الحقيقي &lt; 100</b>: نمو اسمي فقط، خسارة قوة شرائية.</div>
                      <div>• الخطوط الحمراء = سنوات تعويم الجنيه.</div>
                      <div>• المرجع: Case & Shiller (1987) + CAPMAS-CPI + UN-Habitat 2024.</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <TabsContent value="hedonic" className="space-y-4 mt-4">
              {!hed ? (
                <Card><CardContent className="py-8 text-center text-muted-foreground text-sm">
                  عدد العقارات غير كافٍ لبناء نموذج Hedonic (يلزم ≥ 8 عقارات).
                </CardContent></Card>
              ) : (
                <>
                  <Card>
                    <CardHeader><CardTitle className="text-base">المنهجية — Rosen (1974) Hedonic Pricing</CardTitle></CardHeader>
                    <CardContent className="text-xs space-y-2 text-muted-foreground">
                      ...
                      <div>• يفكّك سعر المتر إلى مساهمات منفصلة لكل خاصية (Rosen 1974).</div>
                      <div>• الحلّ: <span dir="ltr" className="font-mono">β = (XᵀX)⁻¹Xᵀy</span></div>
                      <div>• الأثر الهامشي = <span dir="ltr" className="font-mono">(e^β − 1) × 100%</span></div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardHeader><CardTitle className="text-base flex items-center gap-2"><Calculator className="h-4 w-4" />معاملات الانحدار (OLS)</CardTitle></CardHeader>
                    <CardContent>
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          <thead className="text-xs border-b"><tr>
                        ...
                        <div className="text-[10px] text-muted-foreground mt-2">الدلالة: *** عند 1% · ** عند 5% · * عند 10%.</div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardContent className="p-4 text-xs space-y-1 text-muted-foreground bg-muted/40">
                      ...
                      <div>• كل غرفة إضافية: <b>{hed.coefficients[1]?.pct}</b> · كل حمام: <b>{hed.coefficients[2]?.pct}</b>.</div>
                      <div>• كل دور أعلى: <b>{hed.coefficients[3]?.pct}</b> · كل سنة عمر: <b>{hed.coefficients[4]?.pct}</b>.</div>
                      <div>• كل درجة بنية تحتية: <b>{hed.coefficients[5]?.pct}</b>.</div>
                      <div className="pt-1">R² = <b>{hed.r2.toFixed(3)}</b>؛ يفسّر <b>{(hed.r2 * 100).toFixed(0)}%</b> من تباين الأسعار.</div>
                    </CardContent>
                  </Card>
                </>
              )}
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 p-3 bg-muted rounded text-xs space-y-1">
                    ...
                    <div className="pt-2 border-t mt-2">💡 للسوق المصري: قارن مع المؤشر <b>الحقيقي</b> (Case-Shiller المُعدَّل بـ CPI).</div>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
        ...
        <TabsContent value="affordability" className="space-y-4 mt-4">
          <Tabs defaultValue="hai">
            <TabsList className="grid grid-cols-2 w-full">
              <TabsTrigger value="hai">🏠 مؤشر HAI — التملّك</TabsTrigger>
              <TabsTrigger value="mortgage">🏦 التمويل العقاري</TabsTrigger>
            </TabsList>
            <TabsContent value="hai" className="space-y-4 mt-4">
              <Card>
            ...
            <TabsContent value="mortgage" className="mt-4"><Suspense fallback={<PanelFallback />}><MortgageFinancePanel /></Suspense></TabsContent>
          </Tabs>
        </TabsContent>

        {/* ════════════ 5) جودة الموقع والعمران ════════════ */}
        ...
        {/* ════════════ 6) المخاطر والإطار القانوني ════════════ */}
        <TabsContent value="risk" className="space-y-4 mt-4">
          <Tabs defaultValue="climate">
            <TabsList className="grid grid-cols-2 w-full">
              <TabsTrigger value="climate">🌊 LGAF + المخاطر المناخية</TabsTrigger>
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="space-y-3">
                        ...
                        <div className="text-xs text-muted-foreground p-3 bg-muted rounded"><b>توصية:</b> {cr.recommendation}</div>
                      </div>
                    );
                  })()}
                </CardContent>
