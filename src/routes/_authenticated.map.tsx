        ...
        L.circleMarker([a.lat, a.lng], {
          ...
          .bindPopup(`
            <div style="direction:rtl;font-family:system-ui;min-width:200px">
              ...
              <div style="font-size:10px;color:#888;margin-top:6px">${a.hood_desc || ""}</div>
            </div>`)
          .addTo(map);
      });
    })();
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">{data?.areas.length || 0} منطقة · {data?.districts.length || 0} حي · {Object.keys(CITY_CENTERS).length} مدن</p>
      </div>
      <Card>
      ...
      <Card>
        <CardHeader><CardTitle className="text-sm">دليل الألوان (الأحياء)</CardTitle></CardHeader>
